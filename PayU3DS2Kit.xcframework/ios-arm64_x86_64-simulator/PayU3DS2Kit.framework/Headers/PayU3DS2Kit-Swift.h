...
- (nonnull instancetype)initWithAcsSignedContent:(NSString * _Nonnull)acsSignedContent acsRefNumber:(NSString * _Nonnull)acsRefNumber acsTransactionID:(NSString * _Nonnull)acsTransactionID threeDSServerTransactionID:(NSString * _Nonnull)threeDSServerTransactionID cardId:(NSString * _Nullable)cardId tempCardId:(NSString * _Nullable)tempCardId cardBin:(NSString * _Nullable)cardBin clientId:(NSString * _Nullable)clientId bankLogoURL:(NSString * _Nullable)bankLogoURL networkLogoURL:(NSString * _Nullable)networkLogoURL transactionTimeout:(NSInteger)transactionTimeout registrationTimeout:(NSInteger)registrationTimeout fallbackVisibilityDuration:(NSInteger)fallbackVisibilityDuration OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
