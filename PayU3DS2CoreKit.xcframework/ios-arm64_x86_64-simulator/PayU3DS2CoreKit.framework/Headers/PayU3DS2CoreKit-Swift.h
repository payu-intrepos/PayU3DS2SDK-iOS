...
///
- (nonnull instancetype)initWithA3DSServerTransactionID:(NSString * _Nullable)a3DSServerTransactionID acsTransactionID:(NSString * _Nullable)acsTransactionID acsRefNumber:(NSString * _Nullable)acsRefNumber acsSignedContent:(NSString * _Nullable)acsSignedContent threeDSServerTransactionID:(NSString * _Nullable)threeDSServerTransactionID threeDSRequestorAppURL:(NSString * _Nullable)threeDSRequestorAppURL tdyCardId:(NSString * _Nullable)tdyCardId clientId:(NSString * _Nullable)clientId name:(NSString * _Nullable)name id:(NSString * _Nullable)id acsRenderingType:(enum ACSUITypeInt)acsRenderingType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) BOOL isMFARegistered;
- (nonnull instancetype)initWithSdkTransactionID:(NSString * _Nonnull)sdkTransactionID transactionStatus:(NSString * _Nonnull)transactionStatus consentGiven:(BOOL)consentGiven bankId:(NSString * _Nullable)bankId customerId:(NSString * _Nullable)customerId bindingType:(NSString * _Nullable)bindingType isMFARegistered:(BOOL)isMFARegistered OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)getSDKTransactionID SWIFT_WARN_UNUSED_RESULT;
...
enum PayULoaderPresentationStyle : NSInteger;
@interface ConfigParameters (SWIFT_EXTENSION(PayU3DS2CoreKit))
...
/// Sets the style Wibmo will pass into the next <code>Indicator.show(presentationStyle:)</code>.
/// Host SDK updates this per phase (awaiting MFA sheet → <code>.bottomSheet</code>, after auth → <code>.fullScreen</code>).
- (void)setPreferredLoaderPresentationStyle:(enum PayULoaderPresentationStyle)style;
/// Sets bottom-sheet loader height to match the next bottom sheet UI. Pass <code>0</code> for default (449).
- (void)setPreferredBottomSheetLoaderHeight:(CGFloat)height;
/// ObjC / dynamic-friendly setter (<code>0</code> = fullScreen, <code>1</code> = bottomSheet).
- (void)setPreferredLoaderPresentationStyleRawValue:(NSInteger)rawValue;
@end
...
- (void)logKibanaEventWithKey:(NSString * _Nonnull)key value:(NSString * _Nonnull)value className:(NSString * _Nonnull)className eventType:(NSString * _Nonnull)eventType eventSeverity:(NSString * _Nonnull)eventSeverity txnId:(NSString * _Nullable)txnId sdkTime:(NSInteger)sdkTime;
- (void)logKibanaEventWithKey:(NSString * _Nonnull)key value:(NSString * _Nonnull)value className:(NSString * _Nonnull)className eventType:(NSString * _Nonnull)eventType eventSeverity:(NSString * _Nonnull)eventSeverity eventStatus:(NSString * _Nonnull)eventStatus txnId:(NSString * _Nullable)txnId sdkTime:(NSInteger)sdkTime;
@end
...
/// Presentation style for PayU loaders.
/// Use <code>.bottomSheet</code> when the next UI is confirmed to be a bottom sheet; otherwise <code>.fullScreen</code>.
typedef SWIFT_ENUM(NSInteger, PayULoaderPresentationStyle, open) {
  PayULoaderPresentationStyleFullScreen = 0,
  PayULoaderPresentationStyleBottomSheet = 1,
};

@class NSCoder;
SWIFT_CLASS("_TtC15PayU3DS2CoreKit20PayULoadingAnimation")
@interface PayULoadingAnimation : UIView
...
- (void)showPayULoaderWithMessage:(NSString * _Nonnull)message backgroundColor:(UIColor * _Nonnull)backgroundColor alpha:(CGFloat)alpha presentationStyle:(enum PayULoaderPresentationStyle)presentationStyle;
- (void)showPayUBottomSheetLoaderWithMessage:(NSString * _Nonnull)message backgroundColor:(UIColor * _Nonnull)backgroundColor;
- (void)hidePayULoader;
- (void)updateLoaderTextWith:(NSString * _Nonnull)text;
@end
